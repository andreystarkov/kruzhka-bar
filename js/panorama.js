    ...
    $.fn.panorama = function(options) {
        this.each(function(){
            ...
            panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
                .append("<div class='panorama-control'><a href='#' class='panorama-control-left'><i class='icon-double-angle-left'></i></a> <a href='#' class='panorama-control-pause'><i class='icon-pause'></i></a> <a href='#' class='panorama-control-right'><i class='icon-double-angle-right'></i></a> </div>");
            ...
            if (settings.control_display == 'yes') {
                ...
                panoramaViewport.bind('mouseover', function(){
                    $(this).find('.panorama-control').stop().fadeToggle(300);
                    return false;
                }).bind('mouseout', function(){
                    $(this).find('.panorama-control').fadeToggle({duration: 200, queue: false});
                    return false;
                });
