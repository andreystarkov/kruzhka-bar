                ...
                <div class="nav-panel">
                    ...
                    <div class="bell">
                    	...
                    	<div class="nav-menu">
                    		...
                    		title="В меню ресторана &mdash; лучшие сорта светлого и<br> темного пива и уникальные закуски."<? } ?>>Меню ресторана</a>
                    		
                    		<div class="div d6"></div>
                    		
                    		<a href="banket.php" class="int<?if(strstr($_SERVER['REQUEST_URI'], "banket.php") ){ ?> active"<? } else { ?> tooltip-bottom" 
                    		title="Расположенный по соседству с рестораном,<br> уютный и просторный банкетный зал<br> ждет Вас и Ваших гостей."<? } ?>>Интерьер банкетного зала</a>
